...
- **Facturar — brechas P1 destacadas (desde la matriz):** sin UI para parte de `accounting.*` (p. ej. `paymentDate`), catálogos texto libre vs legacy, histórico reciente capado a 40, comprobación PDF por entorno.
